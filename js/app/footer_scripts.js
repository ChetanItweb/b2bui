...
$(function(){
	...
	var exception_fields_arr = ['app_website','sms_username', 'sms_password', 'server_username', 'txt_username', 'app_smtp_host', 'app_smtp_port', 'app_smtp_password', 'app_smtp_method', 'airport_code1','check_in','check_out','check_in1','check_out1','re_password','new_password','current_password','app_name','bank_name','bank_ifsc_code','bank_swift_code','package_name','package_code','package_name1','package_code1','corpo_company_name'];
...

{
      ...
      $.post(base_url+'view/customer_master/corporate_fields_reflect.php',{ cust_type : cust_type, customer_id : customer_id}, function(data){
...

{
	...
	$('.city_master_dropdown').each(function(){
		...
		$.post(base_url+'modal/app_settings/dropdown_master.php', { city_master_dropdown : city_master_dropdown }, function(data){
...
function display_description(type,entry_id){
  var base_url = $('#base_url').val();
  $.post(base_url+'view/load_data/module_description_modal.php', { entry_id: entry_id,type : type }, function(data){
