...
{ 
  ...
  row.cells[7].childNodes[0].setAttribute('onchange','calculate_age_member(id); payment_details_reflected_data("tbl_member_dynamic_row")');
...
{ 
  ...
  row.cells[0].childNodes[0].setAttribute("id", "check-btn-plane-"+prefix+foo.counter);
   ...
   for (var i= row.cells[2].childNodes[0].attributes.length; i-->0;)
    ...
    row.cells[3].childNodes[0].setAttribute("id", "from_city-"+prefix+foo.counter);
    row.cells[3].childNodes[0].setAttribute('onchange','airport_reflect(id)');
    row.cells[4].childNodes[0].setAttribute("id", "plane_from_location-"+prefix+foo.counter);
    row.cells[5].childNodes[0].setAttribute("id", "to_city-"+prefix+foo.counter);
    row.cells[5].childNodes[0].setAttribute('onchange','airport_reflect1(id)');
    row.cells[6].childNodes[0].setAttribute("id", "plane_to_location-"+prefix+foo.counter);
    row.cells[7].childNodes[0].setAttribute("id", "txt_plane_company-"+prefix+foo.counter); 
    row.cells[8].childNodes[0].setAttribute("id", "txt_plane_seats-"+prefix+foo.counter); 
    row.cells[9].childNodes[0].setAttribute("id", "txt_plane_amount-"+prefix+foo.counter);
    row.cells[10].childNodes[0].setAttribute("id", "txt_arravl-"+foo.counter);
    var today = new Date();
    var dd = today.getDate();
    var mm = today.getMonth()+1; //January is 0!
...
{ 
   ...
   for (var i= row.cells[2].childNodes[0].attributes.length; i-->0;)
    ...
    jQuery(row.cells[2].childNodes[0]).addClass('form-control').datetimepicker({ timepicker:false, minDate:new Date(), format:"d-m-Y" });
    jQuery(row.cells[3].childNodes[0]).addClass('form-control').datetimepicker({ timepicker:false, minDate:new Date(), format:"d-m-Y" });
...
if(tableID=="tbl_package_hotel_master")
{
  ...
  row.cells[4].childNodes[0].setAttribute("id", "hotel_type"+foo.counter);
  row.cells[5].childNodes[0].setAttribute("id", "hotel_tota_days1"+foo.counter);  
  if(row.cells[6]){
...
{ 
  ...
  for (var i= row.cells[4].childNodes[0].attributes.length; i-->0;)
          row.cells[4].childNodes[0].removeAttributeNode(row.cells[4].childNodes[0].attributes[i]);
  row.cells[4].childNodes[0].setAttribute("id", "txt_tsp_to_date"+foo.counter); 
  row.cells[4].childNodes[0].setAttribute("class", "form-control");
  row.cells[4].childNodes[0].placeholder="End Date";
...
{ 
  ...
  row.cells[3].childNodes[0].setAttribute("id", "cost1"+foo.counter+prefix);

  if(row.cells[4]){
    row.cells[4].style.display="none";
    row.cells[4].childNodes[0].setAttribute("value", "");
  }  
}
...
{ 
  ...
  row.cells[2].childNodes[0].setAttribute("id", "city_name-"+foo.counter);
  row.cells[3].childNodes[0].setAttribute("id", "excursion-"+foo.counter);
...
if(tableID=="tbl_package_tour_quotation_dynamic_hotel" || tableID=="tbl_package_tour_quotation_dynamic_hotel_update")
{
  ...
  row.cells[2].childNodes[0].setAttribute("id", "city_name1"+prefix+foo.counter);
  row.cells[3].childNodes[0].setAttribute("id", "hotel_name1"+prefix+foo.counter);
  row.cells[4].childNodes[0].setAttribute("id", "hotel_type1"+prefix+foo.counter);
  row.cells[5].childNodes[0].setAttribute("id", "hotel_stay_days1"+prefix+foo.counter);
  row.cells[6].childNodes[0].setAttribute("id", "no_of_rooms1"+prefix+foo.counter);
  row.cells[7].childNodes[0].setAttribute("id", "extra_bedb1"+prefix+foo.counter);
  row.cells[8].childNodes[0].setAttribute("id", "package_name"+prefix+foo.counter);
  row.cells[9].childNodes[0].setAttribute("id", "hotel_cost"+prefix+foo.counter);
  row.cells[10].childNodes[0].setAttribute("id", "package_id"+prefix+foo.counter);
  row.cells[11].childNodes[0].setAttribute("id", "extra_bed_cost"+prefix+foo.counter);
...
if(tableID=="tbl_package_tour_quotation_dynamic_transport")
{
  row.cells[0].childNodes[0].setAttribute("id", "chk_transport1"+foo.counter);

  row.cells[2].childNodes[0].setAttribute("id", "transport_vehicle1"+foo.counter);
  row.cells[3].childNodes[0].setAttribute("id", "transport_start_date1"+foo.counter);
  row.cells[4].childNodes[0].setAttribute("id", "transport_end_date1"+foo.counter);
  row.cells[5].childNodes[0].setAttribute("id", "package_name1"+foo.counter);
  row.cells[6].childNodes[0].setAttribute("id", "transport_cost1"+foo.counter);
  row.cells[7].childNodes[0].setAttribute("id", "package_id1"+foo.counter);
...
if(tableID=="tbl_package_tour_quotation_dynamic_excursion" )
{
  ...
  row.cells[2].childNodes[0].setAttribute("id", "city_name-"+foo.counter);
  row.cells[3].childNodes[0].setAttribute("id", "excursion-"+foo.counter);
  row.cells[4].childNodes[0].setAttribute("id", "excursion_amount-"+foo.counter);
...
if(tableID=="tbl_dynamic_exc_booking" || tableID=="tbl_dynamic_exc_booking_update")
{
  ...
  var prefix = tableID=="tbl_dynamic_exc_booking_update" ? "_u" : "";
  if(prefix!=""){
    ...
    for (var i= row.cells[2].childNodes[0].attributes.length; i-->0;)
    row.cells[2].childNodes[0].removeAttributeNode(row.cells[2].childNodes[0].attributes[i]);
    row.cells[2].childNodes[0].setAttribute("id", "exc_date"+prefix+foo.counter);
    ...
    row.cells[2].childNodes[0].value=today;
    dynamic_datetime(row.cells[2].childNodes[0].id);
    $('#'+row.cells[2].childNodes[0].id).datetimepicker({ format:"d-m-Y H:i" });;
    row.cells[3].childNodes[0].setAttribute("id", "city_name-"+prefix+current_counter);
    $('#'+row.cells[3].childNodes[0].id).select2();
    row.cells[4].childNodes[0].setAttribute("id", "excursion-"+prefix+current_counter);
    row.cells[5].childNodes[0].setAttribute("id", "total_adult-"+prefix+current_counter);
    row.cells[6].childNodes[0].setAttribute("id", "total_children-"+prefix+current_counter);
    row.cells[7].childNodes[0].setAttribute("id", "adult_cost-"+prefix+current_counter);
    row.cells[8].childNodes[0].setAttribute("id", "child_cost-"+prefix+current_counter);
    row.cells[9].childNodes[0].setAttribute("id", "total_amount-"+prefix+current_counter);
  if(row.cells[10]){
    row.cells[10].style.display="hidden";
  }
...
if(tableID=="tbl_package_tour_quotation_dynamic_costing")
{
  ...
  row.cells[2].childNodes[0].setAttribute("id", "tour_cost-"+foo.counter);
  row.cells[3].childNodes[0].setAttribute("id", "transport_cost-"+foo.counter);
  row.cells[4].childNodes[0].setAttribute("id", "excursion_cost-"+foo.counter);
  row.cells[5].childNodes[0].setAttribute("id", "markup_cost-"+foo.counter);
  row.cells[6].childNodes[0].setAttribute("id", "markup_cost_subtotal-"+foo.counter);
  row.cells[7].childNodes[0].setAttribute("id", "taxation_id-"+foo.counter);
  row.cells[8].childNodes[0].setAttribute("id", "service_tax-"+foo.counter);
  row.cells[9].childNodes[0].setAttribute("id", "service_tax_subtotal-"+foo.counter);
  row.cells[10].childNodes[0].setAttribute("id", "total_tour_cost-"+foo.counter);
  row.cells[11].childNodes[0].setAttribute("id", "package_name1"+foo.counter);
  row.cells[12].childNodes[0].setAttribute("id", "package_id"+foo.counter);
  ...
  $(row.cells[11]).addClass('header_btn');
  $(row.cells[12]).addClass('header_btn');
  
  if(row.cells[13]){
    row.cells[13].style.display="hidden";
  }
...
{
  var prefix = tableID=="tbl_package_tour_quotation_dynamic_plane_update" ? "_u" : "";
  row.cells[0].childNodes[0].setAttribute("id", "chk_plan-"+prefix+foo.counter);
  row.cells[2].childNodes[0].setAttribute("id", "from_city-"+prefix+foo.counter);
  row.cells[2].childNodes[0].setAttribute('onchange','airport_reflect(id)');
  row.cells[3].childNodes[0].setAttribute("id", "plane_from_location-"+prefix+foo.counter);
  row.cells[4].childNodes[0].setAttribute("id", "to_city-"+prefix+foo.counter);
  row.cells[4].childNodes[0].setAttribute('onchange','airport_reflect1(id)');
  row.cells[5].childNodes[0].setAttribute("id", "plane_to_location-"+prefix+foo.counter);
  row.cells[6].childNodes[0].setAttribute("id", "airline_name-"+prefix+foo.counter);
  row.cells[7].childNodes[0].setAttribute("id", "plane_class-"+prefix+foo.counter);
...
for (var i= row.cells[8].childNodes[0].attributes.length; i-->0;)
    ...
    row.cells[8].childNodes[0].setAttribute("id", "txt_dapart-"+foo.counter);
    row.cells[8].childNodes[0].placeholder="Departure Date & Time";
    var today = new Date();
    var dd = today.getDate();
    var mm = today.getMonth()+1; //January is 0!
   ...
   for (var i= row.cells[9].childNodes[0].attributes.length; i-->0;)
    ...
    row.cells[9].childNodes[0].setAttribute("id", "txt_arrval1-"+foo.counter);
    row.cells[9].childNodes[0].placeholder="Arrival Date & Time";
    var today = new Date();
    var dd = today.getDate();
    var mm = today.getMonth()+1; //January is 0!
    ...
    row.cells[8].childNodes[0].setAttribute('onchange','get_to_datetime(id,"txt_arrval1-"+foo.counter)');
  jQuery(row.cells[8].childNodes[0]).addClass('form-control').datetimepicker({ format:"d-m-Y H:i:s" });
...
{
  if(tableID=="tbl_flight_quotation_dynamic_plane_update") { var prefix = "_u"; }else{ var prefix = ""; }
  row.cells[0].childNodes[0].setAttribute("id", "chk_plan-"+prefix+foo.counter);
  row.cells[2].childNodes[0].setAttribute("id", "from_city-"+prefix+foo.counter);
  row.cells[2].childNodes[0].setAttribute('onchange','airport_reflect(id)');
  row.cells[3].childNodes[0].setAttribute("id", "plane_from_location-"+prefix+foo.counter);
...
for (var i= row.cells[9].childNodes[0].attributes.length; i-->0;)
    row.cells[9].childNodes[0].removeAttributeNode(row.cells[9].childNodes[0].attributes[i]);
    row.cells[9].childNodes[0].setAttribute("id", "txt_arrval-"+foo.counter);
    row.cells[9].childNodes[0].placeholder="Arrival Date & Time";
    var today = new Date();
    var dd = today.getDate();
    var mm = today.getMonth()+1; //January is 0!
    ...
    row.cells[9].childNodes[0].value=today;
    dynamic_datetime(row.cells[9].childNodes[0].id);
    row.cells[8].childNodes[0].setAttribute('onchange','get_to_datetime(id,"txt_arrval-"+foo.counter)');
  jQuery(row.cells[8].childNodes[0]).addClass('form-control').datetimepicker({ format:"d-m-Y H:i:s" });
  jQuery(row.cells[9].childNodes[0]).addClass('form-control').datetimepicker({ format:"d-m-Y H:i:s" });
...
{
  var prefix = (tableID == "tbl_dynamic_cruise_update") ? "_u" : "";
...
for (var i= row.cells[3].childNodes[0].attributes.length; i-->0;)
    ...
    row.cells[3].childNodes[0].placeholder="Date";
    var today = new Date();
    var dd = today.getDate();
    var mm = today.getMonth()+1; //January is 0!
    var hr = today.getHours();
    ...
    row.cells[4].childNodes[0].setAttribute("id", "route"+prefix+foo.counter);
    row.cells[5].childNodes[0].setAttribute("id", "cabin"+prefix+foo.counter);
...
if(tableID=="tbl_dynamic_car_rental_vehicle" || tableID=="tbl_dynamic_car_rental_vehicle1")
{
  row.cells[0].childNodes[0].setAttribute("id", "chk_vehicle"+foo.counter);
  row.cells[2].childNodes[0].setAttribute("id", "vehicle_no"+foo.counter);
  row.cells[3].childNodes[0].setAttribute("id", "vehicle_model"+foo.counter);
  row.cells[4].childNodes[0].setAttribute("id", "vehicle_driver_name"+foo.counter);
  row.cells[5].childNodes[0].setAttribute("id", "vehicle_mobile_no"+foo.counter);
  row.cells[6].childNodes[0].setAttribute("id", "vehicle_year_of_purchase"+foo.counter);
  row.cells[7].childNodes[0].setAttribute("id", "vehicle_rate"+foo.counter);
  row.cells[8].childNodes[0].setAttribute("id", "vehicle_type"+foo.counter);
}
if(tableID=="tbl_dynamic_car_rental_vehicle1")
{
  $(row.cells[9]).addClass('hidden');
}
...
{
  if(tableID=="tbl_hotel_booking_update") { var prefix = "_u"; }else{ var prefix = ""; }
  ...
  // row.cells[4].childNodes[0].setAttribute("id", "check_in"+prefix+foo.counter);
  // row.cells[5].childNodes[0].setAttribute("id", "check_out"+prefix+foo.counter);
  for (var i= row.cells[4].childNodes[0].attributes.length; i-->0;)
    row.cells[4].childNodes[0].removeAttributeNode(row.cells[4].childNodes[0].attributes[i]);
...
{
  var prefix = tableID=="tbl_dynamic_visa_update" ? "_u" : "";
...
{
  var prefix = tableID=="tbl_dynamic_miscellaneous_update" ? "_u" : "";
  row.cells[0].childNodes[0].setAttribute("id", "chk_visa"+prefix+foo.counter);
  row.cells[2].childNodes[0].setAttribute("id", "first_name"+prefix+foo.counter);
  row.cells[3].childNodes[0].setAttribute("id", "middle_name"+prefix+foo.counter);
  row.cells[4].childNodes[0].setAttribute("id", "last_name"+prefix+foo.counter); 
...
{
  var prefix = tableID=="tbl_dynamic_passport_update" ? "_u" : "";
...
if(tableID=="table_hotel_tarrif"+quot_table_id){
 // var prefix = tableID=="tbl_dynamic_booking_quotation" ? "_u" : "";
...
if(tableID=="table_hotel_weekend_tarrif"){
  row.cells[0].childNodes[0].setAttribute("id", "chk_ticket"+quot_table_id+foo.counter);
  row.cells[2].childNodes[0].setAttribute("id", "room_cat"+foo.counter);
  row.cells[3].childNodes[0].setAttribute("id", "day"+foo.counter);
  row.cells[4].childNodes[0].setAttribute("id", "single_bed"+foo.counter);
  row.cells[5].childNodes[0].setAttribute("id", "double_bed"+foo.counter);
  row.cells[6].childNodes[0].setAttribute("id", "triple_bed"+foo.counter);
  row.cells[7].childNodes[0].setAttribute("id", "cwbed"+foo.counter);
  row.cells[8].childNodes[0].setAttribute("id", "cwobed"+foo.counter);
  row.cells[9].childNodes[0].setAttribute("id", "first_child"+foo.counter);
  row.cells[10].childNodes[0].setAttribute("id", "second_child"+foo.counter);
  row.cells[11].childNodes[0].setAttribute("id", "with_bed"+foo.counter);
  row.cells[12].childNodes[0].setAttribute("id", "queen"+foo.counter);
  row.cells[13].childNodes[0].setAttribute("id", "king"+foo.counter);
  row.cells[14].childNodes[0].setAttribute("id", "quad_bed"+foo.counter);
  row.cells[15].childNodes[0].setAttribute("id", "twin"+foo.counter);
  row.cells[16].childNodes[0].setAttribute("id", "markup_per"+foo.counter);
  row.cells[17].childNodes[0].setAttribute("id", "flat_markup"+foo.counter);
