          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="row mg_bt_20">
                ...
                <div class="col-md-4 text-center">
                  <div class="icon"><img src="<?= BASE_URL ?>images/quotation/p4/childCost.png" class="img-responsive"></div>
                  <h4 class="no-marg"><?php echo $sq_costing['child_cost']; ?></h4>
                  <p>CHILD COST</p>
                </div>
                <div class="col-md-4 text-center">
              ...
              <div class="row">
                ...
                <div class="col-md-4 text-center">
                  <div class="icon"><img src="<?= BASE_URL ?>images/quotation/p4/extra-bed.png" class="img-responsive"></div>
                  <h4 class="no-marg"><?php echo $sq_costing['extra_bedc']; ?></h4>
                  <p>EXTRA BED</p>
                </div>
              </div>
              <?php } ?>
