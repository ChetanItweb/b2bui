...
public function finance_save($refund_id)
{
    ...
    $payment_particular = get_refund_paid_particular(get_car_rental_booking_id($booking_id,$yr1), $refund_date, $refund_amount, $refund_mode,get_car_rental_booking_refund_id($refund_id,$yr1));
    $ledger_particular = '';
    $gl_id = $pay_gl;
    $payment_side = "Credit";
    $clearance_status = "";
...
public function bank_cash_book_save($refund_id)
{
	...
	$transaction_id = $transaction_id;
	$bank_id = $bank_id;
	$particular = get_refund_paid_particular(get_car_rental_booking_id($booking_id,$yr1), $refund_date, $refund_amount, $refund_mode, get_car_rental_booking_refund_id($refund_id,$yr1));
...
global $app_email_id, $app_name, $app_contact_no, $admin_logo_url, $app_website;
 ...
 <tr>
    <td>
	      ...
	      <tr>
	        <td style="background: rgba(255, 255, 255, 0.23);color: #000;">
	          <p style="line-height: 24px;padding: 0 0 0 15px;">Booking ID : '.$sq_sq_train_info['booking_id'].'</p>
	          <p style="line-height: 24px;padding: 0 0 0 15px;">Refund Amount : '.$refund_amount.'</p>
	          <p style="line-height: 24px;padding: 0 0 0 15px;">Payment Date : '.$refund_date.'</p>
  ...
  $model->app_email_send('41',$cust_email['email_id'], $content, $subject);
 }
