...
public function exc_booking_email_send($exc_id)

{
		...
		<tr>
			<td>
				<table style="width:100%">	
					<tr>
						<td>			
							<p style="line-height:24px;margin-bottom: 0;">
								<span style="font-weight: bold"> Booking ID : </span> '.get_exc_booking_id($exc_id,$year).'
							</p>
						</td>
					</tr>
					<tr>
	...
	$model->app_email_send('94',$email_id, $content,$subject);
	$model->app_email_send('94',$backoffice_email_id, $content, $subject);
