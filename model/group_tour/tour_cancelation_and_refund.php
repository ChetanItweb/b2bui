...
public function finance_save($refund_id)
{
  ...
  ////////Refund Amount//////
    ...
    $payment_particular = get_refund_paid_particular(get_group_booking_id($tourwise_id,$year), $refund_date, $refund_amount, $refund_mode,get_group_booking_group_refund_id($refund_id,$year));
    $ledger_particular = '';
    $gl_id = $pay_gl;
    $payment_side = "Credit";
    $clearance_status = "";
...
public function bank_cash_book_save($refund_id)
{
  ...
  $transaction_id = $transaction_id;
  $bank_id = $bank_id;
  $particular = get_refund_paid_particular(get_group_booking_id($tourwise_id,$year), $refund_date, $refund_amount, $refund_mode, get_group_booking_group_refund_id($refund_id,$year));
