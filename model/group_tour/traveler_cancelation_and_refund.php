...
global $app_email_id, $app_name, $app_contact_no, $admin_logo_url, $app_website;
  ...
  $sq_sq_train_info = mysql_fetch_assoc(mysql_query("select * from tourwise_traveler_details where tourwise_id='$tourwise_id'"));
      ...
      <table style="width:100%" cellspacing="0">
        ...
        <tr>
          <td style="background: rgba(255, 255, 255, 0.23);color: #000;">
            <p style="line-height: 24px;padding: 0 0 0 15px;">Booking No : '.$sq_sq_train_info['booking_id'].'</p>
            <p style="line-height: 24px;padding: 0 0 0 15px;">Total Refund : '.$refund_amount.'</p>
