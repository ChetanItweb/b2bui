...
public function quotation_email()
{
	...
	$quotation_cost = $sq_cost['total_tour_cost'] + $sq_quotation['train_cost'] + $sq_quotation['flight_cost'] + $sq_quotation['cruise_cost'] + $sq_quotation['visa_cost'] + $sq_quotation['guide_cost'];	
	...
	$content .= '          
                        <td>
                            <table cellpadding="0" cellspacing="0" style="width: 100%;">
								...
								<tr>
									<td colspan="2" style="padding-left: 10px;border-bottom: 1px solid #eee;"><span style="font-weight: 600; color: #009898;">'.$quot_note.'</span></td>
								</tr>
                            </table>
                        </td>
