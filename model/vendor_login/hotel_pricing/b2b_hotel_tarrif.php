...
public function hotel_tarrif_save(){
	...
	$termsnconditions = $_POST['termsnconditions'];
	...
	$tab2_single_bed_array = $_POST['tab2_single_bed_array'];
	$tab2_double_bed_array = $_POST['tab2_double_bed_array'];
	$tab2_triple_bed_array = $_POST['tab2_triple_bed_array'];
	$tab2_chwithbed_array = $_POST['tab2_chwithbed_array'];
	$tab2_chwobed_array = $_POST['tab2_chwobed_array'];
	$tab2_fchild_array = $_POST['tab2_fchild_array'];
	$tab2_schild_array = $_POST['tab2_schild_array'];
	$tab2_extra_bed_array = $_POST['tab2_extra_bed_array'];
	$tab2_queen_bed_array = $_POST['tab2_queen_bed_array'];
	$tab2_king_bed_array = $_POST['tab2_king_bed_array'];
	$tab2_quad_bed_array = $_POST['tab2_quad_bed_array'];
	$tab2_twin_bed_array = $_POST['tab2_twin_bed_array'];
	...
	$tab3_single_bed_array = $_POST['tab3_single_bed_array'];
	$tab3_double_bed_array = $_POST['tab3_double_bed_array'];
	$tab3_triple_bed_array = $_POST['tab3_triple_bed_array'];
	$tab3_chwithbed_array = $_POST['tab3_chwithbed_array'];
	$tab3_chwobed_array = $_POST['tab3_chwobed_array'];
	$tab3_fchild_array = $_POST['tab3_fchild_array'];
	$tab3_schild_array = $_POST['tab3_schild_array'];
	$tab3_extra_bed_array = $_POST['tab3_extra_bed_array'];
	$tab3_queen_bed_array = $_POST['tab3_queen_bed_array'];
	$tab3_king_bed_array = $_POST['tab3_king_bed_array'];
	$tab3_quad_bed_array = $_POST['tab3_quad_bed_array'];
	$tab3_twin_bed_array = $_POST['tab3_twin_bed_array'];
	...
	$tab4_single_bed_array = $_POST['tab4_single_bed_array'];
	$tab4_double_bed_array = $_POST['tab4_double_bed_array'];
	$tab4_triple_bed_array = $_POST['tab4_triple_bed_array'];
	$tab4_chwithbed_array = $_POST['tab4_chwithbed_array'];
	$tab4_chwobed_array = $_POST['tab4_chwobed_array'];
	$tab4_fchild_array = $_POST['tab4_fchild_array'];
	$tab4_schild_array = $_POST['tab4_schild_array'];
	$tab4_extra_bed_array = $_POST['tab4_extra_bed_array'];
	$tab4_queen_bed_array = $_POST['tab4_queen_bed_array'];
	$tab4_king_bed_array = $_POST['tab4_king_bed_array'];
	$tab4_quad_bed_array = $_POST['tab4_quad_bed_array'];
	$tab4_twin_bed_array = $_POST['tab4_twin_bed_array'];
	...
	$terms_conditions = addslashes($termsnconditions);
	$sq_login = mysql_query("insert into hotel_vendor_price_master (pricing_id, city_id,hotel_id, currency_id , inclusions, exclusions, terms_conditions,check_in,check_out, created_at) values ('$pricing_id','$city_id','$hotel_id','$currency_id', '$inclusions', '$exclusions', '$terms_conditions','$check_in','$check_out', '$created_at')");
	if($sq_login){
		//TAB-2
		for($i=0; $i<sizeof($tab2_from_date_array); $i++){
			...
			$tab2_single_bed_array[$i] = mysql_real_escape_string($tab2_single_bed_array[$i]);
			$tab2_double_bed_array[$i] = mysql_real_escape_string($tab2_double_bed_array[$i]);
			$tab2_triple_bed_array[$i] = mysql_real_escape_string($tab2_triple_bed_array[$i]);
			...
			$tab2_fchild_array[$i] = mysql_real_escape_string($tab2_fchild_array[$i]);
			$tab2_schild_array[$i] = mysql_real_escape_string($tab2_schild_array[$i]);
			$tab2_extra_bed_array[$i] = mysql_real_escape_string($tab2_extra_bed_array[$i]);
			$tab2_queen_bed_array[$i] = mysql_real_escape_string($tab2_queen_bed_array[$i]);
			$tab2_king_bed_array[$i] = mysql_real_escape_string($tab2_king_bed_array[$i]);
			$tab2_quad_bed_array[$i] = mysql_real_escape_string($tab2_quad_bed_array[$i]);
			$tab2_twin_bed_array[$i] = mysql_real_escape_string($tab2_twin_bed_array[$i]);
		...
		for($i=0; $i<sizeof($tab3_from_date_array); $i++){
			...
			$tab3_single_bed_array[$i] = mysql_real_escape_string($tab3_single_bed_array[$i]);
			$tab3_double_bed_array[$i] = mysql_real_escape_string($tab3_double_bed_array[$i]);
			$tab3_triple_bed_array[$i] = mysql_real_escape_string($tab3_triple_bed_array[$i]);
			...
			$tab3_fchild_array[$i] = mysql_real_escape_string($tab3_fchild_array[$i]);
			$tab3_schild_array[$i] = mysql_real_escape_string($tab3_schild_array[$i]);
			$tab3_extra_bed_array[$i] = mysql_real_escape_string($tab3_extra_bed_array[$i]);
			$tab3_queen_bed_array[$i] = mysql_real_escape_string($tab3_queen_bed_array[$i]);
			$tab3_king_bed_array[$i] = mysql_real_escape_string($tab3_king_bed_array[$i]);
			$tab3_quad_bed_array[$i] = mysql_real_escape_string($tab3_quad_bed_array[$i]);
			$tab3_twin_bed_array[$i] = mysql_real_escape_string($tab3_twin_bed_array[$i]);
			...
			$sq1 = mysql_query("INSERT INTO `hotel_blackdated_tarrif`(`entry_id`, `pricing_id`, `room_category`, `from_date`, `to_date`, `single_bed`, `double_bed`, `triple_bed`, `child_with_bed`, `child_without_bed`, `first_child`, `second_child`, `extra_bed`, `queen_bed`, `king_bed`, `quad_bed`, `twin_bed`, `markup_per`, `markup`, `meal_plan`) VALUES ('$max_entry_id','$pricing_id','$tab3_room_cat_array[$i]','$tab3_from_date_array[$i]','$tab3_to_date_array[$i]','$tab3_single_bed_array[$i]','$tab3_double_bed_array[$i]','$tab3_triple_bed_array[$i]','$tab3_chwithbed_array[$i]','$tab3_chwobed_array[$i]','$tab3_fchild_array[$i]','$tab3_schild_array[$i]','$tab3_extra_bed_array[$i]','$tab3_queen_bed_array[$i]','$tab3_king_bed_array[$i]','$tab3_quad_bed_array[$i]','$tab3_twin_bed_array[$i]','$tab3_markup_per_array[$i]','$tab3_markup_cost_array[$i]','$tab3_meal_plan_array[$i]')");
			if(!$sq1){
				$GLOBALS['flag'] = false;
		...
		for($i=0; $i<sizeof($tab4_room_cat_array); $i++){
			...
			$sq1 = mysql_query("INSERT INTO `hotel_weekend_tarrif`(`entry_id`, `pricing_id`, `room_category`, `day`, `single_bed`, `double_bed`, `triple_bed`, `child_with_bed`, `child_without_bed`, `first_child`, `second_child`, `extra_bed`, `queen_bed`, `king_bed`, `quad_bed`, `twin_bed`, `markup_per`, `markup`, `meal_plan`) VALUES ('$max_entry_id','$pricing_id','$tab4_room_cat_array[$i]','$tab4_day_array[$i]','$tab4_single_bed_array[$i]','$tab4_double_bed_array[$i]','$tab4_triple_bed_array[$i]','$tab4_chwithbed_array[$i]','$tab4_chwobed_array[$i]','$tab4_fchild_array[$i]','$tab4_schild_array[$i]','$tab4_extra_bed_array[$i]','$tab4_queen_bed_array[$i]','$tab4_king_bed_array[$i]','$tab4_quad_bed_array[$i]','$tab4_twin_bed_array[$i]','$tab4_markup_per_array[$i]','$tab4_markup_cost_array[$i]','$tab4_meal_plan_array[$i]')");
			if(!$sq1){
				$GLOBALS['flag'] = false;
...
public function hotel_tarrif_update(){
	...
	$exclusions = addslashes($exclusions);
	$terms_conditions = addslashes($termsnconditions);
	$sq_login = mysql_query("update hotel_vendor_price_master set city_id='$city_id',hotel_id='$hotel_id', currency_id='$currency_id' , inclusions='$inclusions', exclusions='$exclusions', terms_conditions='$terms_conditions',check_in='$check_in',check_out='$check_out' where pricing_id='$pricing_id'");
	if($sq_login){
		//TAB-2
		for($i=0; $i<sizeof($tab2_from_date_array); $i++){
			if($tab2_entry_id_array[$i] == ''){
				...
				$sq1 = mysql_query("UPDATE `hotel_contracted_tarrif` SET `room_category`='$tab2_room_cat_array[$i]',`from_date`='$tab2_from_date_array[$i]',`to_date`='$tab2_to_date_array[$i]',`single_bed`='$tab2_single_bed_array[$i]',`double_bed`='$tab2_double_bed_array[$i]',`triple_bed`='$tab2_triple_bed_array[$i]',`child_with_bed`='$tab2_chwithbed_array[$i]',`child_without_bed`='$tab2_chwobed_array[$i]',`first_child`='$tab2_fchild_array[$i]',`second_child`='$tab2_schild_array[$i]',`extra_bed`='$tab2_extra_bed_array[$i]',`queen_bed`='$tab2_queen_bed_array[$i]',`king_bed`='$tab2_king_bed_array[$i]',`quad_bed`='$tab2_quad_bed_array[$i]',`twin_bed`='$tab2_twin_bed_array[$i]',`markup_per`='$tab2_markup_per_array[$i]',`markup`='$tab2_markup_cost_array[$i]',`meal_plan`='$tab2_meal_plan_array[$i]' WHERE entry_id='$tab2_entry_id_array[$i]'");
			}
			if(!$sq1){
				$GLOBALS['flag'] = false;
		...
		for($i=0; $i<sizeof($tab3_from_date_array); $i++){
			if($tab3_entry_id_array[$i] == ''){
				...
				$sq1 = mysql_query("UPDATE `hotel_blackdated_tarrif` SET `room_category`='$tab3_room_cat_array[$i]',`from_date`='$tab3_from_date_array[$i]',`to_date`='$tab3_to_date_array[$i]',`single_bed`='$tab3_single_bed_array[$i]',`double_bed`='$tab3_double_bed_array[$i]',`triple_bed`='$tab3_triple_bed_array[$i]',`child_with_bed`='$tab3_chwithbed_array[$i]',`child_without_bed`='$tab3_chwobed_array[$i]',`first_child`='$tab3_fchild_array[$i]',`second_child`='$tab3_schild_array[$i]',`extra_bed`='$tab3_extra_bed_array[$i]',`queen_bed`='$tab3_queen_bed_array[$i]',`king_bed`='$tab3_king_bed_array[$i]',`quad_bed`='$tab3_quad_bed_array[$i]',`twin_bed`='$tab3_twin_bed_array[$i]',`markup_per`='$tab3_markup_per_array[$i]',`markup`='$tab3_markup_cost_array[$i]',`meal_plan`='$tab3_meal_plan_array[$i]' WHERE entry_id='$tab3_entry_id_array[$i]'");
			}
			if(!$sq1){
				$GLOBALS['flag'] = false;
		...
		for($i=0; $i<sizeof($tab4_room_cat_array); $i++){
			if($tab4_entry_id_array[$i] == ''){
				...
				$sq1 = mysql_query("UPDATE `hotel_weekend_tarrif` SET `room_category`='$tab4_room_cat_array[$i]',`day`='$tab4_day_array[$i]',`single_bed`='$tab4_single_bed_array[$i]',`double_bed`='$tab4_double_bed_array[$i]',`triple_bed`='$tab4_triple_bed_array[$i]',`child_with_bed`='$tab4_chwithbed_array[$i]',`child_without_bed`='$tab4_chwobed_array[$i]',`first_child`='$tab4_fchild_array[$i]',`second_child`='$tab4_schild_array[$i]',`extra_bed`='$tab4_extra_bed_array[$i]',`queen_bed`='$tab4_queen_bed_array[$i]',`king_bed`='$tab4_king_bed_array[$i]',`quad_bed`='$tab4_quad_bed_array[$i]',`twin_bed`='$tab4_twin_bed_array[$i]',`markup_per`='$tab4_markup_per_array[$i]',`markup`='$tab4_markup_cost_array[$i]',`meal_plan`='$tab4_meal_plan_array[$i]' WHERE entry_id='$tab4_entry_id_array[$i]'");
			}
			if(!$sq1){
				$GLOBALS['flag'] = false;
		...
		for($i=0; $i<sizeof($from_date_array); $i++){
			...
			if(!$sq1){
				$GLOBALS['flag'] = false;
				echo "error--Offers/Discounts Tariff details not updated!";
			}
		}		
		commit_t();
