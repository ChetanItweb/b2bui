...
<div class="row"> <div class="col-xs-12"> <div class="table-responsive">
    ...
    <table id="tbl_dynamic_cruise_package_booking" name="tbl_dynamic_cruise_package_booking" class="table table-bordered table-hover mg_bt_30 no-marg-sm">
        <tr>
            <td><input class="css-checkbox" id="chk_cruise1" type="checkbox" onchange="calculate_cruise_expense('tbl_dynamic_cruise_package_booking')" checked><label class="css-label" for="chk_cruise1"><label></td>
            <td><input maxlength="15" value="1" type="text" name="username" placeholder="Sr. No." class="form-control" disabled /></td>
            <td><input type="text" id="cruise_departure_date" name="cruise_departure_date" placeholder="Departure Date & Time" title="Departure Date & Time" class="app_datetimepicker" value="<?= date('d-m-Y H:i:s') ?>" onchange="get_to_datetime(this.id,'cruise_arrival_date');" style="width:136px"></td>
            <td><input type="text" id="cruise_arrival_date" name="cruise_arrival_date" placeholder="Arrival Date & Time" title="Arrival Date & Time" class="app_datetimepicker" value="<?= date('d-m-Y H:i:s') ?>" style="width:136px"></td>
            ...
            <td><input type="text" id="txt_cruise_amount1" name="txt_cruise_amount1" placeholder="*Amount" title="Amount" style="width:136px" onchange="validate_balance(this.id);" onkeyup=" calculate_cruise_expense('tbl_dynamic_cruise_package_booking');"  style="width:120px"/></td>
        </tr>
    </table>
