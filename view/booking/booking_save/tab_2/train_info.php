...
<div class="row"> <div class="col-xs-12"> <div class="table-responsive">
    ...
    <table id="tbl_train_travel_details_dynamic_row" name="tbl_train_travel_details_dynamic_row" class="table table-bordered table-hover bg_white no-marg-sm mg_bt_30">
        <tr>
            ...
            <td><input type="text" id="txt_train_date1" name="txt_train_date1" Title="Departure Date & Time" placeholder="*Departure Date & Time" style="width:136px"/></td>
           ...
           <td><select id="txt_train_from_location1" name="txt_train_from_location1" title="From Location" onchange="validate_location('txt_train_to_location1' , 'txt_train_from_location1')" class="app_select2" style="width:120px">
            ...
            <td><input type="text" id="txt_train_amount1" name="txt_train_amount1"  class="text-right" placeholder="*Amount" title="Amount" onchange="validate_balance(this.id);" onkeyup=" calculate_train_expense('tbl_train_travel_details_dynamic_row');" style="width:120px"/></td>
