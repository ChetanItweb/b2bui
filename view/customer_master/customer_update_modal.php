    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
          ...
          <div class="row mg_bt_10">
            <div class="col-sm-4 mg_bt_10_sm_xs">
              <input type="text" id="contact_no1" name="contact_no1" onchange="mobile_validate(this.id)"  placeholder="*Mobile No" title="Mobile No" value="<?= $sq_customer['contact_no'] ?>">
            </div>
            <div class="col-sm-4 mg_bt_10_sm_xs">
              <input type="text" id="email_id1" name="email_id1" placeholder="Email ID" title="Email ID" value="<?= $sq_customer['email_id'] ?>">
            </div> 
            <div class="col-sm-4 mg_bt_10_sm_xs">
        ...
        <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 mg_bt_10_sm_xs">
                <select name="active_flag1" id="active_flag1" title="Active Flag">
