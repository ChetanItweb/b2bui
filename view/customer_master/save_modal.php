    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
            ...
            <div class="row mg_bt_10">
              <div class="col-sm-4 col-xs-12">
                <input type="text" id="cust_contact_no" name="cust_contact_no" maxlength="11" onchange="mobile_validate(this.id)" placeholder="*Mobile No" title="Mobile No">
              </div>
              <div class="col-sm-4 col-xs-12">
          ...
          <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 col-xs-12">
                <select name="cust_active_flag" id="cust_active_flag" title="Active Flag" class="hidden">
