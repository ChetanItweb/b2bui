            ...
            <div class="row">
              ...
              <div class="col-xs-12">
                ...
                <div class="forex_chk">
                  ...
                  <input type="checkbox" id="hotel_advance_residence_proof" name="residence_proof" value="Hotel Advance Payment Voucher">
        ...
        <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                ...
                <input type="text" id="rate" name="rate" placeholder="*Rate" title="Rate" onchange="calculate_total_amount();validate_balance(this.id)">

              </div>              

              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">

                <input type="text" id="forex_amount" name="forex_amount" placeholder="*Forex Amount" title="Forex Amount" onchange="calculate_total_amount();validate_balance(this.id)">

              </div>

              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">

                <input type="text" id="basic_cost" class="text-right" name="basic_cost" placeholder="Total" title="Total" onchange="calculate_total_amount();validate_balance(this.id)" readonly>
        ...
        <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                ...
                <input type="text" id="payment_amount" name="payment_amount" placeholder="*Amount" title="Amount" onchange="payment_amount_validate(this.id,'payment_mode','transaction_id','bank_name','bank_id');number_validate(this.id)">
