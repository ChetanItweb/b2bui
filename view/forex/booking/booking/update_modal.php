            ...
            <div class="row">
              ...
              <div class="col-xs-12">
                ...
                <div class="forex_chk">
                  ...
                  <?php $chk = (in_array("Hotel Advance Payment Voucher", $residence_proof_arr)) ? "checked" : ""; ?>

                  <input type="checkbox" id="hotel_advance_residence_proof" name="residence_proof" value="Hotel Advance Payment Voucher" <?= $chk ?>>
        ...
        <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                ...
                <input type="text" id="rate" name="rate" placeholder="Rate" title="Rate" onchange="calculate_total_amount();validate_balance(this.id)" value="<?= $sq_booking['rate'] ?>">

              </div>              

              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">

                <input type="text" id="forex_amount" name="forex_amount" placeholder="Forex Amount" title="Forex Amount" onchange="calculate_total_amount();validate_balance(this.id)" value="<?= $sq_booking['forex_amount'] ?>">

              </div>

              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">

                <input type="text" id="basic_cost" name="basic_cost" placeholder="Total" title="Total" onchange="calculate_total_amount();validate_balance(this.id)" readonly value="<?= $sq_booking['basic_cost'] ?>">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <input type="text" name="booking_date1" id="booking_date1" value="<?= get_date_user($sq_booking['created_at']) ?>" placeholder="Booking Date" title="Booking Date" onchange="check_valid_date(this.id)">
              </div>
              ...
              if(data !== 'valid'){
                ...
                return false;
                  ...
                  $.ajax({
                    ...
                    data:{  booking_id : booking_id, customer_id : customer_id, manadatory_docs : manadatory_docs, photo_proof_given : photo_proof_given, residence_proof : residence_proof, booking_type : booking_type, currency_code : currency_code, rate : rate, forex_amount : forex_amount, basic_cost : basic_cost, service_charge : service_charge, taxation_type : taxation_type, taxation_id : taxation_id, service_tax : service_tax, service_tax_subtotal : service_tax_subtotal, net_total : net_total,booking_date1 : booking_date1 },
