	...
	<div class="col-md-10  col-md-offset-1 col-sm-12 col-xs-12">
		<div class="widget_parent-bg-img bg-img-red">
			<?php     
	            ...
	            begin_widget();
	                $title_arr = array("Booking Amount", "Service Charge", "Tax", "Discount","TDS","Total Amount");
	                $content_arr = array( $sq_hotel_info['sub_total'] , $sq_hotel_info['service_charge'], $sq_hotel_info['service_tax_subtotal'],$sq_hotel_info['discount'],$sq_hotel_info['tds'], $sq_hotel_info['total_fee']);
	...
	<form id="frm_refund">
		...
		<div class="row text-center">
			<div class="col-md-3 col-md-offset-3 col-sm-6 col-xs-12 mg_bt_10_xs">
				<input type="text" name="cancel_amount" id="cancel_amount" class="text-right" placeholder="*Cancel Amount" title="Cancel Amount" onchange="validate_balance(this.id);calculate_total_refund()" value="<?= $sq_hotel_info['cancel_amount'] ?>">
			</div>
