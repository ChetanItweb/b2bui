...
<!--=======Header panel end======-->
        <div class="container">
        <h5 class="booking-section-heading main_block">Hotel Contracted Tariff</h5>
			<div class="row mg_bt_10">
				<div class="col-md-12 text-right text_center_xs">
					<div class="col-md-6 text-left">
						...
						<div class="div-upload  mg_bt_20" id="div_upload_button1">
							<div id="b2btariff_csv_upload" class="upload-button1"><span>CSV</span></div>
    ...
    $.ajax({
        ...
        success:function(result){
            ...
            for(var i=0; i<pass_arr.length; i++){
                ...
                row.cells[10].childNodes[0].value = pass_arr[i]['first_child'];
				row.cells[11].childNodes[0].value = pass_arr[i]['second_child'];				
                row.cells[12].childNodes[0].value = pass_arr[i]['with_bed'];
                row.cells[13].childNodes[0].value = pass_arr[i]['queen'];
                row.cells[14].childNodes[0].value = pass_arr[i]['king'];
                row.cells[15].childNodes[0].value = pass_arr[i]['quad_bed'];
				row.cells[16].childNodes[0].value = pass_arr[i]['twin_bed'];
