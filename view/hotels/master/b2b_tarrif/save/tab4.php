...
<!--=======Header panel end======-->
        ...
        <h5 class="booking-section-heading main_block">Weekend Rates</h5>
          ...
          <div class="col-md-6 text-left">
              <input type="button" class="btn btn-sm btnType" onclick="display_format_modal1();" value="View CSV">
    ...
    $.ajax({
        ...
        success:function(result){
            ...
            for(var i=0; i<pass_arr.length; i++){
                ...
                row.cells[3].childNodes[0].value = pass_arr[i]['day'];
                row.cells[4].childNodes[0].value = pass_arr[i]['single_bed'];
                row.cells[5].childNodes[0].value = pass_arr[i]['double_bed'];
                row.cells[6].childNodes[0].value = pass_arr[i]['triple_bed'];
                row.cells[7].childNodes[0].value = pass_arr[i]['cwbed'];
                row.cells[8].childNodes[0].value = pass_arr[i]['cwobed'];
                row.cells[9].childNodes[0].value = pass_arr[i]['first_child'];
                row.cells[10].childNodes[0].value = pass_arr[i]['second_child'];				
                row.cells[11].childNodes[0].value = pass_arr[i]['with_bed'];
                row.cells[12].childNodes[0].value = pass_arr[i]['queen'];
                row.cells[13].childNodes[0].value = pass_arr[i]['king'];
                row.cells[14].childNodes[0].value = pass_arr[i]['quad_bed'];
                row.cells[15].childNodes[0].value = pass_arr[i]['twin_bed'];
                row.cells[16].childNodes[0].value = pass_arr[i]['markup_per'];
                row.cells[17].childNodes[0].value = pass_arr[i]['flat_markup'];				
                row.cells[18].childNodes[0].value = pass_arr[i]['meal_plan'];
