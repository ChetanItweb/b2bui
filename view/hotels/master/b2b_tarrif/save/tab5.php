...
$('#frm_tab5').validate({
	...
	submitHandler:function(form){
		...
		$.ajax({
			...
			data:{ city_id : city_id,hotel_id : hotel_id,currency_id:currency_id,check_in:check_in,check_out:check_out,inclusions:inclusions,exclusions:exclusions,termsnconditions:termsnconditions,
