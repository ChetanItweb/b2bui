...
<!--=======Header panel end======-->
        ...
        <div class="row mg_bt_20">
            ...
            <div class="col-md-2 mg_bt_10">
                <input type="text" id="check_in" name="check_in" placeholder="Check In Time" title="Check In Time" value='<?= $sq_query['check_in'] ?>' />
            </div>
            <div class="col-md-2 mg_bt_10">
                <input type="text" id="check_out" name="check_out" placeholder="Check Out Time" title="Check Out Time" value='<?= $sq_query['check_out'] ?>' />
            </div>
        </div>
        </div>
        ...
        <div class="row mg_tp_20">
            <div class="col-md-6">
                ...
                <TEXTAREA  id="inclusions" class="feature_editor" style="width: 100%" name="inclusions" placeholder="Inclusions" title="Inclusions"><?= $sq_query['inclusions'] ?></textarea>
            </div>
            <div class="col-md-6">
                <h3 class="editor_title">Exclusions</h3>	
                <TEXTAREA id="exclusions" class="feature_editor" style="width: 100%;" name="exclusions" placeholder="Exclusions" title="Exclusions"><?= $sq_query['exclusions'] ?></textarea>
            </div>
            <div class="col-md-12 mg_tp_20">
                <h3 class="editor_title">Terms & Conditions</h3>
                <TEXTAREA id="terms_conditions" class="feature_editor" style="width: 100%;" name="terms_conditions" placeholder="Terms & Conditions" title="Terms & Conditions"><?= $sq_query['terms_conditions'] ?></textarea>
            </div>
...
<script>
$('#currency_code1,#cmb_city_id,#cmb_hotel_id').select2();
