            ...
            <div class="app_panel_content Filter-panel">
                <div class="row ">
                       ...
                       if($sq_booking_info['quotation_id'] != 0){
                        ...
                        $quotation_cost = $sq_booking_info['train_cost'] + $sq_booking_info['flight_cost'] + $sq_booking_info['cruise_cost'] + $sq_booking_info['visa_cost'] + $sq_booking_info['guide_cost'] + $sq_cost['total_tour_cost'];
                       ?>
...
<h5 class="booking-section-heading main_block">Passenger Details</h5>
    ...
    ?>    
        <tr class="<?= $bg?>">
        <td ><input id="<?php echo "check-btn-member-".$count_m.'m' ?>" type="checkbox" checked disabled ></td>
