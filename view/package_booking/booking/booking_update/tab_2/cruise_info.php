...
<div class="row mg_bt_30"> <div class="col-xs-12"> <div class="table-responsive">
    ...
    ?>
        <tr>
            <td><input class="css-checkbox" id="<?php echo 'chk_cruise1-'.$count_t.'t' ?>" type="checkbox" onchange="calculate_cruise_expense('tbl_dynamic_cruise_package_booking')" checked disabled><label class="css-label" for="chk_cruise1"><label></td>
    ...
    <div class="row">
        ...
        <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
            ...
            <select name="cruise_taxation_id" id="cruise_taxation_id" title="Tax" placeholder="Tax" onchange="generic_tax_reflect(this.id, 'cruise_service_tax', 'calculate_total_cruise_expense');">
                <?php 
                if($sq_booking_info['cruise_taxation_id']!='0'){
                    $sq_taxation = mysql_fetch_assoc(mysql_query("select * from taxation_master where taxation_id='$sq_booking_info[cruise_taxation_id]'"));
