    ...
    submitHandler:function(form){
      ...
      for(var i=0; i<rowCount; i++)
      {
        ...
        {              
          ...
          var arrval1 = row.cells[10].childNodes[0].value;
      ...
      //**Transport travel details starts here
        ...
        var trans_entry_id_arr = new Array();
              ...
              if(row.cells[5]){
                var trans_entry_id = row.cells[5].childNodes[0].value;
              }
              else{
                var trans_entry_id = "";
              }
        ...
        var exc_entry_id_arr = new Array();
              ...
              if(row.cells[4]){
                var exc_entry_id = row.cells[4].childNodes[0].value;
              }
              else{
                var exc_entry_id = "";
              }
              ...
              if(data1=="yes"){
                ...
                $("#btn_package_tour_master_update").button('loading');
                  ...
                  $.post( 
                         ...
                         { booking_id : booking_id, customer_id : customer_id, tour_name : tour_name, tour_type : tour_type, tour_from_date : tour_from_date, tour_to_date : tour_to_date, total_tour_days : total_tour_days, taxation_type : taxation_type, 'm_honorific[]' : m_honorific, 'm_first_name[]' : m_first_name, 'm_middle_name[]' : m_middle_name, 'm_last_name[]' : m_last_name, 'm_gender[]' : m_gender, 'm_birth_date[]' : m_birth_date, 'm_age[]' : m_age, 'm_adolescence[]' : m_adolescence, m_passport_no : m_passport_no, m_passport_issue_date : m_passport_issue_date, m_passport_expiry_date : m_passport_expiry_date, 'm_traveler_id[]' : m_traveler_id, contact_person_name : contact_person_name, email_id : email_id, mobile_no : mobile_no, address : address, country_name : country_name, city : city, state : state, train_expense : train_expense, train_service_charge : train_service_charge, train_taxation_id : train_taxation_id, train_service_tax : train_service_tax, train_service_tax_subtotal : train_service_tax_subtotal, total_train_expense : total_train_expense, plane_expense : plane_expense, plane_service_charge : plane_service_charge, plane_taxation_id : plane_taxation_id, plane_service_tax : plane_service_tax, plane_service_tax_subtotal : plane_service_tax_subtotal, total_plane_expense : total_plane_expense, total_travel_expense : total_travel_expense, train_ticket_path : train_ticket_path, plane_ticket_path : plane_ticket_path, 'train_travel_date[]' : train_travel_date, 'train_from_location[]' : train_from_location, 'train_to_location[]' : train_to_location, 'train_train_no[]' : train_train_no, 'train_travel_class[]' : train_travel_class, 'train_travel_priority[]' : train_travel_priority, 'train_amount[]' : train_amount, 'train_seats[]' : train_seats, 'train_id[]' : train_id, 'plane_travel_date[]' : plane_travel_date, 'plane_from_location[]' : plane_from_location, 'plane_to_location[]' : plane_to_location, 'plane_amount[]' : plane_amount, 'plane_seats[]' : plane_seats, 'plane_company[]' : plane_company, 'plane_id[]' : plane_id,from_city_id_arr : from_city_id_arr,  to_city_id_arr : to_city_id_arr, 'city_id[]' : city_id, 'hotel_id[]' : hotel_id, 'hotel_from_date[]' : hotel_from_date, 'hotel_to_date[]' : hotel_to_date, 'hotel_rooms[]' : hotel_rooms, 'hotel_catagory[]' : hotel_catagory, 'room_type[]' : room_type, 'hotel_meal_plan[]' : hotel_meal_plan,transp_vehicle_arr:transp_vehicle_arr,transp_start_date:transp_start_date,trans_end_date:trans_end_date,trans_entry_id_arr:trans_entry_id_arr,exc_city_arr:exc_city_arr,exc_name_arr:exc_name_arr,exc_entry_id_arr:exc_entry_id_arr, confirmation_no : confirmation_no, 'hotel_acc_id[]' : hotel_acc_id ,visa_country_name : visa_country_name, visa_amount : visa_amount, visa_service_charge : visa_service_charge, visa_taxation_id : visa_taxation_id, visa_service_tax : visa_service_tax, visa_service_tax_subtotal : visa_service_tax_subtotal, visa_total_amount : visa_total_amount, insuarance_company_name : insuarance_company_name, insuarance_amount : insuarance_amount, insuarance_service_charge : insuarance_service_charge, insuarance_taxation_id : insuarance_taxation_id, insuarance_service_tax : insuarance_service_tax, insuarance_service_tax_subtotal : insuarance_service_tax_subtotal, insuarance_total_amount : insuarance_total_amount, total_hotel_expense : total_hotel_expense, total_tour_cost : total_tour_cost, subtotal : subtotal, tour_taxation_id : tour_taxation_id, tour_service_tax : tour_service_tax, tour_service_tax_subtotal : tour_service_tax_subtotal, currency_code : currency_code, rue_cost : rue_cost, subtotal_with_rue : subtotal_with_rue, tour_cost_total : tour_cost_total, actual_tour_cost : actual_tour_cost, special_request : special_request, booking_date : booking_date, 'arrval_arr[]' : arrval_arr,cruise_dept_date_arr : cruise_dept_date_arr,cruise_arrival_date_arr : cruise_arrival_date_arr,route_arr : route_arr,cabin_arr : cabin_arr,sharing_arr : sharing_arr,cruise_seats_arr : cruise_seats_arr, cruise_amount_arr : cruise_amount_arr,cruise_id_arr : cruise_id_arr,cruise_ticket_path : cruise_ticket_path, cruise_expense : cruise_expense, cruise_service_charge : cruise_service_charge, cruise_taxation_id : cruise_taxation_id, cruise_service_tax : cruise_service_tax, cruise_service_tax_subtotal : cruise_service_tax_subtotal, total_cruise_expense : total_cruise_expense,incl:incl,excl:excl,quotation_id:quotation_id,special_attraction_arr:special_attraction_arr,day_program_arr:day_program_arr,stay_arr:stay_arr,meal_plan_arr:meal_plan_arr,iti_entry_id_arr:iti_entry_id_arr },
                         function(data) {      
                                console.log(data);
