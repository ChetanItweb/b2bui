...
$query1 = "SELECT * from package_payment_master where booking_id='$booking_id' AND payment_for='Tour'";
...
?>
<hr>
<input type="hidden" id="total_sale" name="total_sale" value="<?= $sq_pck_info['actual_tour_expense'] + $sq_pck_info['total_travel_expense'] ?>">	        
		...
		<div class="widget_parent-bg-img bg-img-red">
			<div class="widget_parent">
				<div class="stat_content main_block">
					...
					<span class="main_block content_span">
					 	<span class=" stat_content-tilte pull-left">Total Tour Paid</span>
...
<form id="frm_refund">
	...
	<div class="row text-center">
		<div class="col-md-3 col-md-offset-3 col-sm-6 col-xs-12 mg_bt_10_xs">
			<input type="text" name="cancel_amount" id="cancel_amount"  class="text-right" placeholder="*Cancel Amount" title="Cancel Amount" onchange="validate_balance(this.id);calculate_total_refund()" value="<?= $sq_p_info['cancel_amount'] ?>">
		</div>
