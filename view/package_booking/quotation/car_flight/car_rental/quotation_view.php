...
<div class="app_panel_content Filter-panel">
	...
	<div class="row">
		...
		<div class="col-md-3 mg_bt_10" style="border-right: 1px solid #ddd;"> <label>Travelling Date</label> : <?= get_date_user($sq_quotation['traveling_date']) ?> </div>
