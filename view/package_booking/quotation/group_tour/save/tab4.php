...
<div class="row mg_bt_10">
	...
	<div class="col-md-2">
  		...
  		<input type="text" id="adult_cost" name="adult_cost" placeholder="Adult Cost" title="Adult Cost" onchange="group_quotation_cost_calculate();validate_balance(this.id)" value="0" >  
  	...
  	<div class="col-md-2">
  		...
  		<input type="text" id="children_cost" name="children_cost" placeholder="Children Cost" title="Children Cost" value="0" onchange="group_quotation_cost_calculate(); validate_balance(this.id);"> 
	...
	<div class="col-md-2"> 
	 	...
	 	<input type="text" id="infant_cost" name="infant_cost" placeholder="Infant Cost" title="Infant Cost" value="0" onchange="group_quotation_cost_calculate();validate_balance(this.id);">  
    ...
    <div class="col-md-2">
	  	...
	  	<input type="text" id="with_bed_cost" name="with_bed_cost" placeholder="With Bed Cost" title="With Bed Cost" value="0" onchange="group_quotation_cost_calculate();validate_balance(this.id);"> 

	</div>

	<div class="col-md-2">

	    <input type="text" id="tour_cost" name="tour_cost" placeholder="Total Tour Cost" title="Total Tour Cost" value="0" onchange="group_quotation_cost_calculate();validate_balance(this.id);">
	...
	<div class="col-md-2 <?= $add_class ?>">		  
   		...
   		<input type="text" id="markup_cost" name="markup_cost" onchange="group_quotation_cost_calculate(); validate_balance(this.id)"  placeholder="Markup Cost(%)" title="Markup Cost(%)">
 ...
 <div class="row mg_bt_10">
	<div class="col-md-2 <?= $add_class ?>">		  
   		...
   		<input type="text" id="markup_cost_subtotal" name="markup_cost_subtotal" onchange="group_quotation_cost_calculate(); validate_balance(this.id)"  placeholder="Markup Cost Subtotal" title="Markup Cost Subtotal">

	</div>

 	<div class="col-md-2">

  		<select name="taxation_id" id="taxation_id" title="Tax" onchange="group_quotation_cost_calculate();generic_tax_reflect(this.id, 'service_tax', 'group_quotation_cost_calculate');">
