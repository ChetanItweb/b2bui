...
<form id="frm_tab4_u">
	...
	<div class="col-md-2">
  	...
  	<div class="col-md-2">
  		...
  		<input type="text" id="children_cost2" name="children_cost2" placeholder="Children Cost" title="Children Cost" onchange="group_quotation_cost_calculate1();validate_balance(this.id)"  value="<?php echo $sq_quotation['children_cost']; ?>"> 
    ...
    <div class="col-md-2">
    	<input type="hidden" id="pck_with_bed_cost" name="pck_with_bed_cost" value="<?= $row_cost['with_bed_cost'] ?>">
	  	<input type="text" id="with_bed_cost2" name="with_bed_cost2" placeholder="With Bed Cost" title="With Bed Cost"  onchange="group_quotation_cost_calculate1();validate_balance(this.id)"  value="<?php echo $sq_quotation['with_bed_cost']; ?>"> 
	</div>
	<div class="col-md-2">
...
function cost_reflect()
{
  ...
  var total_children = $('#total_children1').val();
  ...
  var child_cost1 = total_children * pck_child_cost;
