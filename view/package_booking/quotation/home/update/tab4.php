		...
		var table = document.getElementById("tbl_package_tour_quotation_dynamic_hotel_update");
...

		  {
...

		    {
		       ...
		       var hotel_stay_days1 = row.cells[5].childNodes[0].value;   

		       var total_rooms = row.cells[6].childNodes[0].value;  

		       var extra_bed = row.cells[7].childNodes[0].value;  		       

		       var package_name1 = row.cells[8].childNodes[0].value;  		      

	           var hotel_cost = row.cells[9].childNodes[0].value;   

	           var extra_bed_cost = row.cells[11].childNodes[0].value;

	          
	           if(row.cells[12] && row.cells[12].childNodes[0]){
	           		var hotel_id1 = row.cells[12].childNodes[0].value;
	           }
	           else{
	           		var hotel_id1 = '';
	           }
