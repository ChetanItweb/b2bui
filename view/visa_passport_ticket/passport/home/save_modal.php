	        ...
	        <div class="panel panel-default panel-body fieldset mg_tp_30">
	        	...
	        	<div class="row mg_bt_10">
	        		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
		        		<input type="text" id="passport_issue_amount" name="passport_issue_amount" placeholder="*Amount" title="Amount" onchange="calculate_total_amount();validate_balance(this.id)">
		        	</div>  
	        		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
		...
		$.post(base_url+'view/load_data/finance_date_validation.php', { check_date: check_date1 }, function(data){
			...
			$('#btn_passport_master_save').button('loading');
					$.ajax({
						...
						data:{ customer_id : customer_id, passport_issue_amount : passport_issue_amount, service_charge : service_charge, taxation_type : taxation_type, taxation_id : taxation_id, service_tax : service_tax, service_tax_subtotal : service_tax_subtotal, passport_total_cost : passport_total_cost, payment_date : payment_date, payment_amount : payment_amount, payment_mode : payment_mode, bank_name : bank_name, transaction_id : transaction_id, honorific_arr : honorific_arr, first_name_arr : first_name_arr, middle_name_arr : middle_name_arr, last_name_arr : last_name_arr, birth_date_arr : birth_date_arr, adolescence_arr : adolescence_arr, received_documents_arr : received_documents_arr, bank_id : bank_id, due_date : due_date,emp_id : emp_id, balance_date : balance_date, branch_admin_id : branch_admin_id,financial_year_id :financial_year_id},
						success: function(result){
							$('#btn_passport_master_save').button('reset');
