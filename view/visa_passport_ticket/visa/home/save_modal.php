	        	...
	        	<legend>Passenger Details</legend>
				 ...
				 <div class="row mg_bt_10">
	                <div class="col-xs-12 text-right text_center_xs">
	                    ...
	                    <button type="button" class="btn btn-danger btn-sm ico_left" onClick="deleteRow('tbl_dynamic_visa')"><i class="fa fa-times"></i>&nbsp;&nbsp;Delete</button>
	                </div>
	            </div>
...
<script>
$('#issue_date1, #expiry_date1, #payment_date, #due_date,#balance_date').datetimepicker({ timepicker:false, format:'d-m-Y' });
var date = new Date();
						...
						if(data !== 'valid'){
							...
							return false;
								...
								$.ajax({
									...
									data:{ emp_id : emp_id, customer_id : customer_id, visa_issue_amount : visa_issue_amount, service_charge : service_charge, taxation_type : taxation_type, taxation_id : taxation_id, service_tax : service_tax, service_tax_subtotal : service_tax_subtotal, visa_total_cost : visa_total_cost, payment_date : payment_date, payment_amount : payment_amount, payment_mode : payment_mode, bank_name : bank_name, transaction_id : transaction_id, first_name_arr : first_name_arr, middle_name_arr : middle_name_arr, last_name_arr : last_name_arr, birth_date_arr : birth_date_arr, adolescence_arr : adolescence_arr, visa_country_name_arr : visa_country_name_arr, visa_type_arr : visa_type_arr, passport_id_arr : passport_id_arr, issue_date_arr : issue_date_arr, expiry_date_arr : expiry_date_arr, nationality_arr : nationality_arr, received_documents_arr : received_documents_arr, bank_id : bank_id, due_date : due_date,balance_date : balance_date, branch_admin_id : branch_admin_id,financial_year_id : financial_year_id},
									success: function(result){
